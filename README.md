# React Date ADA-compliant Picker

A fork of react-ada-datepicker component for React with accessibility improvements.
...
```
npm install react-ada-datepicker --save
```
...
// CSS Modules, react-ada-datepicker-cssmodules.css
// import 'react-ada-datepicker/dist/react-ada-datepicker-cssmodules.css';
...
See [here](https://github.com/Hacker0x01/react-ada-datepicker/blob/master/docs/datepicker.md) for a full list of props that may be passed to the component. Examples are given on the [main website](https://hacker0x01.github.io/react-ada-datepicker).
...
More examples of how to use the time picker are given on the [main website](https://hacker0x01.github.io/react-ada-datepicker)
...
* React 15.5 or newer: All above react-ada-datepicker v.0.40.0
* React 15.4.1: needs react-ada-datepicker v0.40.0, newer won't work (due to react-onclickoutside dependencies)
* React 0.14 or newer: All above react-ada-datepicker v0.13.0
* React 0.13: react-ada-datepicker v0.13.0
* pre React 0.13: react-ada-datepicker v0.6.2
