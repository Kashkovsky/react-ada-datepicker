...
describe("Day", () => {
  describe("rendering", () => {
    it("should render the specified day", () => {
      ...
      expect(shallowDay.hasClass("react-ada-datepicker__day")).to.equal(true);
    ...
    it("should apply the day of week class", () => {
      let day = newDate();
      for (var i = 0; i < 7; i++) {
        const className = "react-ada-datepicker__day--" + getDayOfWeekCode(day);
        const shallowDay = renderDay(day);
  ...
  describe("selected", () => {
    const className = "react-ada-datepicker__day--selected";
  ...
  describe("keyboard-selected", () => {
    const className = "react-ada-datepicker__day--keyboard-selected";
  ...
  describe("highlighted", () => {
    const className = "react-ada-datepicker__day--highlighted";
  ...
  describe("in range", () => {
    const className = "react-ada-datepicker__day--in-range";
  ...
  describe("in selecting range", () => {
    const rangeDayClassName = "react-ada-datepicker__day--in-selecting-range";
    const rangeDayStartClassName =
      "react-ada-datepicker__day--selecting-range-start";
    const rangeDayEndClassName =
      "react-ada-datepicker__day--selecting-range-end";
  ...
  describe("today", () => {
    const className = "react-ada-datepicker__day--today";
  ...
  describe("weekend", () => {
    const className = "react-ada-datepicker__day--weekend";
  ...
  describe("outside month", () => {
    const className = "react-ada-datepicker__day--outside-month";
  ...
  describe("disabled", () => {
    const className = "react-ada-datepicker__day--disabled";
  ...
  describe("click", () => {
    ...
    it("should call onClick if day is enabled", () => {
      ...
      dayNode.find(".react-ada-datepicker__day").simulate("click");
  ...
  describe("mouse enter", () => {
    ...
    it("should call onMouseEnter if day is hovered", () => {
      ...
      shallowDay.find(".react-ada-datepicker__day").simulate("mouseenter");
